...
Object.defineProperty(exports, "DestinationsModule", {
    enumerable: true,
    get: function() {
...
const _destinationscontroller = require("./destinations.controller");
...
DestinationsModule = _ts_decorate([
    (0, _common.Module)({
        controllers: [
            _destinationscontroller.DestinationsController
        ],
        providers: [
