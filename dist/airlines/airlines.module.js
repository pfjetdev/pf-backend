...
Object.defineProperty(exports, "AirlinesModule", {
    enumerable: true,
    get: function() {
...
const _airlinescontroller = require("./airlines.controller");
...
AirlinesModule = _ts_decorate([
    (0, _common.Module)({
        controllers: [
            _airlinescontroller.AirlinesController
        ],
        providers: [
